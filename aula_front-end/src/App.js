...
const endereco = '0xd13d0Ad35B4232146E3F0E6f866aA99cb840E680'
const abiLock = '[{"anonymous":false,"inputs":[{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"when","type":"uint256"}],"name":"Withdrawal","type":"event"},{"inputs":[],"name":"owner","outputs":[{"internalType":"address payable","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"unlockTime","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"withdraw","outputs":[],"stateMutability":"nonpayable","type":"function"}]'

const endereco2 = '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'
...
function App() {
  ...
  let lerVariavel = async() => {
    // console.log('lerVariavel')
    // console.log('providerState.provider')
    // console.log(providerState.provider)
    // const contractCriado = new ethers.Contract(endereco, abiLock, providerState.provider)
    // const qualquer = await contractCriado.unlockTime()
    // console.log('qualquer', qualquer.toString())

    const signer = providerState.provider.getSigner()
    console.log('signer', signer)
    const usdcContract = new ethers.Contract(endereco2, abiUSDC)
    const usdcWithSigner = usdcContract.connect(signer);

    await usdcWithSigner.transfer('0xe7d58047c9f36F61b144416b7e7c56D28776BF5f', '1')
  }
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <button type="button" onClick={lerVariavel}>ethereumsp</button>
